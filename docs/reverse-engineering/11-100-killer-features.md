# 11 · The Killer Features Catalog — 186 Source-Verified Features

> The brief asked for "at least 100 killer features". A systematic sweep of every controller,
> model, library, admin module, DB table, and Laravel service — cross-referenced against the ten
> specialized research passes in this documentation set — produced **186 verified features**.
> Every entry cites real file paths (and line numbers where meaningful) in the repository.
>
> Legend: **[legacy]** = PHP app at the repo root · **[next]** = `necoyoad-next/` Laravel rewrite ·
> **[both]** = exists on both sides.
