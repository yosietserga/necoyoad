...
class ControllerModuleProductList extends ControllerModuleModuleController
{
    ...
    public function init()
    {
        $this->addFilter("module:settings", function ($data) {
            ...
            $query_data['product_type'] = $this->request->hasQuery('product_type') ?
                $this->request->getQuery('product_type') : 
                (isset($settings['product_type']) ? $settings['product_type'] : '');
