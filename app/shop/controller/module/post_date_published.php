...
class ControllerModulePostDatePublished extends ControllerModuleModuleController
{
    protected string $moduleName = 'post_date_published';
    ...
    public function init()
    {
        $this->addFilter("module:settings", function ($data) {
            ...
            if (isset($results[0])) {
                $this->data['created'] = $results[0]['date_publish_start'];
            }
