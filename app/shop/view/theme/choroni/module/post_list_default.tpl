    ...
    <?php foreach($posts as $post) { ?>
        ...
        <div class="info nt-hoverdir">
            ...
            <ul class="glossary-item-footer">
                <li class="post-visits"><?php echo $post['visits']??0; ?> <?php echo $l('Visits'); ?></li>
                <li class="post-follow"><?php echo $post['followers']??0; ?> <?php echo $l('Followers'); ?></li>
                <li class="post-likes"><?php echo $post['likes']??0; ?> <?php echo $l('Likes'); ?></li>
                <li class="post-dislikes"><?php echo $post['dislikes']??0; ?> <?php echo $l('Dislikes'); ?></li>
            </ul>
        </div>
        <!-- /post-info -->
    </li>
