...
<?php $settings['class'] = !empty($settings['class']) ? $settings['class'].' banner-horizontal' : 'banner-horizontal'; ?>
    ...
    <ul class="container">
        ...
        <li class="item">
            ...
            <?php if (!empty($item['link'])) { ?><a href="<?php echo $item['link']; ?>"><?php } ?>
                <div class="thumb" style="position: relative;z-index: 9;overflow: hidden">
                    <img src="<?php echo HTTP_IMAGE . $item['image']; ?>" alt="<?php $item['image']; ?>" width="100%" />
