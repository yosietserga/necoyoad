...
<?php $settings['class'] = !empty($settings['class']) ? $settings['class'].' banner-hhe-02' : 'banner-hhe-02'; ?>
...
<div class="widget-content" id="<?php echo $widgetName; ?>Content" data-banner="horizontal">
    <ul>
        ...
        <li class="item"<?php if (isset($style)) { echo ' style="'. $style .'"'; } ?>>
            <div class="ch-item">
                <div class="ch-info">
                    <div class="ch-info-front" style="background-image:url(<?php echo HTTP_IMAGE . $item['image']; ?>)"></div>
