...
class ModelAccountOrder extends Model {
	...
	public function getOrders($data=array()) {
        ...
        $sql .= "LEFT JOIN `" . DB_PREFIX . "status` os ON (o.order_status_id = os.status_id AND os.object_type = 'order_status') ";
        $sql .= "LEFT JOIN `" . DB_PREFIX . "description` dos ON (os.status_id = dos.object_id AND dos.object_type = 'order_status' AND dos.language_id = '" . (int)$this->config->get('config_language_id') . "') ";
	...
	public function getOrderStatuses() {
        ...
        $sql .= "WHERE os.object_type = 'order_status' AND dos.language_id = '" . (int)$this->config->get('config_language_id') . "'";
		$query = $this->db->query($sql);
