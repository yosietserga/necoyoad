...
<div class="container">
    ...
    <div class="box">
        ...
        <?php if ($post_id) { ?><a href="<?php echo $Url::createUrl("content/post",array('post_id'=>$post_id),'NONSSL',HTTP_CATALOG); ?>" target="_blank"><?php echo $l('text_see_post_in_frontstore'); ?></a><?php } ?>
        <div class="buttons">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div id="general"><?php require_once(dirname(__FILE__)."/post_form_general.tpl"); ?></div>
            <div id="data"><?php require_once(dirname(__FILE__)."/post_form_data.tpl"); ?></div>
            <div id="widgets"><?php require_once(dirname(__FILE__)."/post_form_widgets.tpl"); ?></div>
        </form>
    </div>
</div>
<?php echo $footer; ?>