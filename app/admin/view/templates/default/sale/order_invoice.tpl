...
<!--[if gt IE 8]><!--> <html class="no-js" lang="<?php echo $language; ?>"> <!--<![endif]-->
    ...
    <body>
        ...
        <div style="page-break-after: always;">
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <?php echo $l('text_telephone'); ?> <?php echo $order['telephone']; ?><br />
                            <?php if ($order['fax']) { ?>
                            <?php echo $l('text_fax'); ?> <?php echo $order['fax']; ?><br />
                            <?php } ?>
                        ...
                        <td style="text-align: right;">
                            <table>
                                <tr style="text-align: right;">
                                    <td><b><?php echo $l('text_date_added'); ?></b></td>
                                    <td><?php echo $order['date_added']; ?></td>
                                </tr>
                                <?php if ($order['invoice_id']) { ?>
                                <tr style="text-align: right;">
                                    <td><b><?php echo $l('text_invoice_id'); ?></b></td>
                                    <td><?php echo $order['invoice_id']; ?></td>
                                </tr>
                                <?php } ?>
                                <tr style="text-align: right;">
                                    <td><b><?php echo $l('text_order_id'); ?></b></td>
            ...
            <table class="product">
                <tr class="heading">
                    <td><b><?php echo $l('column_comment'); ?></b></td>
                </tr>
                <tr>
