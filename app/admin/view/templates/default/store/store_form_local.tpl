<div>
    ...
    <div class="row">
        ...
        <?php foreach ($countries as $country) { ?>
            <option value="<?php echo $country['country_id']; ?>"<?php if ($country['country_id'] == $config_country_id) { ?> selected="selected"<?php } ?>><?php echo $country['title']; ?></option>
        <?php } ?>
        </select>
    </div>
    ...
    <div class="row">
        ...
        <input class="necoDecimals<?php if (isset($error_decimal_separator)) echo ' neco-input-error'; ?>" type="text" title="<?php echo $l('help_decimal_separator'); ?>" name="config_decimal_separator" value="<?php echo $config_decimal_separator; ?>" required="true" />
    </div>
    ...
    <div class="row">
        ...
        <input class="necoThousands<?php if (isset($error_decimal_separator)) echo ' neco-input-error'; ?>" type="text" title="<?php echo $l('help_thousands_separator'); ?>" name="config_thousands_separator" value="<?php echo $config_thousands_separator; ?>" required="true" />
    </div>
