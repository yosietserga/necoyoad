<div class="grid_12">
    <table class="chartOrders" data-graph-container-before="1" data-graph-type="pie" data-graph-datalabels-enabled="1">
        <thead>
            <tr>
...
<script>$('table.ordersChart').highchartTable();</script>