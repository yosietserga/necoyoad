    ...
    <table class="form">
        ...
        <tr>
		  ...
		  <tr>
            ...
            <td><input title="<?php echo $l('help_new_days'); ?>" type="necoNumber" name="config_new_days" value="<?php echo $config_new_days; ?>" size="3" required="true"<?php if (isset($error_new_days)) echo ' class="neco-input-error'; ?> /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><?php echo $l('entry_order_payment_status'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_payment_status_approved'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_payment_status_returned'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_payment_status_no_approved'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_status_paid'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_status_loading'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_status_shipping'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_status_delivered'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_status_nulled'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_status_aborted'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
          ...
          <tr>
            <td><?php echo $l('entry_order_status_returned'); ?><br><span class="help">Establecer el estado predeterminado cuando un pedido es realizada.</span></td>
