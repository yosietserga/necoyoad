    ...
    <div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                ...
                <select name="free_checkout_newsletter_id" title="<?php echo $l('help_newsletter_id'); ?>">
            ...
            <div class="row">
                ...
                <select title="<?php echo $l('help_status'); ?>" name="free_checkout_status">
                    <option value="1"<?php if ($free_checkout_status) { ?> selected="selected"<?php } ?>><?php echo $l('text_enabled'); ?></option>
                    <option value="0"<?php if (!$free_checkout_status) { ?> selected="selected"<?php } ?>><?php echo $l('text_disabled'); ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $l('help_sort_order'); ?>" type="text" name="free_checkout_sort_order" value="<?php echo $free_checkout_sort_order; ?>" style="width: 40%;" />
            </div>
