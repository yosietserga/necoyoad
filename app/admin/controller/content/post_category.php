...
class ControllerContentPostCategory extends ControllerAdmin
{

    protected string $object_type       = 'post_category'; //this will be saved into related tables

    protected string $model_name        = 'modelPost_category';  //this will load main model class
    protected string $model_route       = 'content/post_category'; //path to main model class
    protected string $model_object_type = 'post_category'; // to set into mode

    protected string $controller_name   = 'post_category'; //controller name
    protected string $controller_route  = 'content/post_category'; //controller route

    protected string $controller_template_basename = 'post_category'; //template controller name
    protected string $controller_template_route = 'content/post_category'; //template controller path
