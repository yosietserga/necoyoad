<?php
/**
 * ControllerModuleManufacturerImageUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleManufacturerImageUninstall extends Controller {
	private $error = [];
    private $module = 'manufacturer_image';
	
	/**
	 * ControllerModuleManufacturerImageUninstall::index()
	 * 
	 * @return
	 */
