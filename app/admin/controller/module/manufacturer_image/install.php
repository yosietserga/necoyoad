...
/**
 * ControllerModuleManufacturerImageInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleManufacturerImageInstall extends Controller {

    private $error = [];
    private $module = 'manufacturer_image';

    /**
     * ControllerModuleManufacturerImageInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleManufacturerImageInstall::validate()
     * 
     * @return
     */
