...
/**
 * ControllerModuleCategoryTitleInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCategoryTitleInstall extends Controller {

    private $error = [];
    private $module = 'category_title';

    /**
     * ControllerModuleCategoryTitleInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleCategoryTitleInstall::validate()
     * 
     * @return
     */
