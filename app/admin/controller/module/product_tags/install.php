...
/**
 * ControllerModuleProductTagsInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductTagsInstall extends Controller {

    private $error = [];
    private $module = 'product_tags';

    /**
     * ControllerModuleProductTagsInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductTagsInstall::validate()
     * 
     * @return
     */
