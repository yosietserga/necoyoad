<?php
/**
 * ControllerModuleCategoryDescriptionUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCategoryDescriptionUninstall extends Controller {
	private $error = [];
    private $module = 'category_description';
	
	/**
	 * ControllerModuleCategoryDescriptionUninstall::index()
	 * 
	 * @return
	 */
