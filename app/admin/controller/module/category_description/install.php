...
/**
 * ControllerModuleCategoryDescriptionInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCategoryDescriptionInstall extends Controller {

    private $error = [];
    private $module = 'category_description';

    /**
     * ControllerModuleCategoryDescriptionInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleCategoryDescriptionInstall::validate()
     * 
     * @return
     */
