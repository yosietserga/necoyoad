...
/**
 * ControllerModuleProductStockInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductStockInstall extends Controller {

    private $error = [];
    private $module = 'product_stock';

    /**
     * ControllerModuleProductStockInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductStockInstall::validate()
     * 
     * @return
     */
