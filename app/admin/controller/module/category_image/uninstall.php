<?php
/**
 * ControllerModuleCategoryImageUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCategoryImageUninstall extends Controller {
	private $error = [];
    private $module = 'category_image';
	
	/**
	 * ControllerModuleCategoryImageUninstall::index()
	 * 
	 * @return
	 */
