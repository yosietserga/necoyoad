...
/**
 * ControllerModulePostCategoryOverviewInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryOverviewInstall extends Controller {

    private $error = [];
    private $module = 'post_category_overview';

    /**
     * ControllerModulePostCategoryOverviewInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostCategoryOverviewInstall::validate()
     * 
     * @return
     */
