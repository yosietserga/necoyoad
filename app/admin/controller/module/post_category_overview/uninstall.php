<?php
/**
 * ControllerModulePostCategoryOverviewUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryOverviewUninstall extends Controller {
	private $error = [];
    private $module = 'post_category_overview';
	
	/**
	 * ControllerModulePostCategoryOverviewUninstall::index()
	 * 
	 * @return
	 */
