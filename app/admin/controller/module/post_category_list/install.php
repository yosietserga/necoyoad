...
/**
 * ControllerModulePostCategoryListInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryListInstall extends Controller {

    private $error = [];
    private $module = 'post_category_list';

    /**
     * ControllerModulePostCategoryListInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostCategoryListInstall::validate()
     * 
     * @return
     */
