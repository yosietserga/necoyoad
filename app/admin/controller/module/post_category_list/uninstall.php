<?php
/**
 * ControllerModulePostCategoryListUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryListUninstall extends Controller {
	private $error = [];
    private $module = 'post_category_list';
	
	/**
	 * ControllerModulePostCategoryListUninstall::index()
	 * 
	 * @return
	 */
