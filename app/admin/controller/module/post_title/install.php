...
/**
 * ControllerModulePostTitleInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostTitleInstall extends Controller {

    private $error = [];
    private $module = 'post_title';

    /**
     * ControllerModulePostTitleInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostTitleInstall::validate()
     * 
     * @return
     */
