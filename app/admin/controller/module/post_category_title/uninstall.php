<?php
/**
 * ControllerModulePostCategoryTitleUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryTitleUninstall extends Controller {
	private $error = [];
    private $module = 'post_category_title';
	
	/**
	 * ControllerModulePostCategoryTitleUninstall::index()
	 * 
	 * @return
	 */
