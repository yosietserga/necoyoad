...
/**
 * ControllerModulePostCategoryTitleInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryTitleInstall extends Controller {

    private $error = [];
    private $module = 'post_category_title';

    /**
     * ControllerModulePostCategoryTitleInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostCategoryTitleInstall::validate()
     * 
     * @return
     */
