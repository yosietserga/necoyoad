...
/**
 * ControllerModulePluginTemplateInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePluginTemplateInstall extends Controller {

    private $error = [];
    private $module = 'plugin_template';

    /**
     * ControllerModulePluginTemplateInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePluginTemplateInstall::validate()
     * 
     * @return
     */
