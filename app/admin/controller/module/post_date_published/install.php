...
/**
 * ControllerModulePostDatePublishedInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostDatePublishedInstall extends Controller {

    private $error = [];
    private $module = 'post_date_published';

    /**
     * ControllerModulePostDatePublishedInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostDatePublishedInstall::validate()
     * 
     * @return
     */
