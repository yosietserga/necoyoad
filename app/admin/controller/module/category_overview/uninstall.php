<?php
/**
 * ControllerModuleCategoryOverviewUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCategoryOverviewUninstall extends Controller {
	private $error = [];
    private $module = 'category_overview';
	
	/**
	 * ControllerModuleCategoryOverviewUninstall::index()
	 * 
	 * @return
	 */
