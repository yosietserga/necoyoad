...
/**
 * ControllerModuleCategoryOverviewInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCategoryOverviewInstall extends Controller {

    private $error = [];
    private $module = 'category_overview';

    /**
     * ControllerModuleCategoryOverviewInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleCategoryOverviewInstall::validate()
     * 
     * @return
     */
