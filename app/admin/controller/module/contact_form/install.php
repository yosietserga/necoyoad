...
/**
 * ControllerModuleContactFormInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleContactFormInstall extends Controller {

    private $error = [];
    private $module = 'contact_form';

    /**
     * ControllerModuleContactFormInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleContactFormInstall::validate()
     * 
     * @return
     */
