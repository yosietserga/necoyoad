<?php
/**
 * ControllerModulePageDescriptionUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePageDescriptionUninstall extends Controller {
	private $error = [];
    private $module = 'page_description';
	
	/**
	 * ControllerModulePageDescriptionUninstall::index()
	 * 
	 * @return
	 */
