...
/**
 * ControllerModulePageDescriptionInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePageDescriptionInstall extends Controller {

    private $error = [];
    private $module = 'page_description';

    /**
     * ControllerModulePageDescriptionInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePageDescriptionInstall::validate()
     * 
     * @return
     */
