<?php
/**
 * ControllerModuleProductAttributesUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductAttributesUninstall extends Controller {
	private $error = [];
    private $module = 'product_attributes';
	
	/**
	 * ControllerModuleProductAttributesUninstall::index()
	 * 
	 * @return
	 */
