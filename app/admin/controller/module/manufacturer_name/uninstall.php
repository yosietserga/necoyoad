<?php
/**
 * ControllerModuleManufacturerNameUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleManufacturerNameUninstall extends Controller {
	private $error = [];
    private $module = 'manufacturer_name';
	
	/**
	 * ControllerModuleManufacturerNameUninstall::index()
	 * 
	 * @return
	 */
