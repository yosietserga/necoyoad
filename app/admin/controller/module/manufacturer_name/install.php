...
/**
 * ControllerModuleManufacturerNameInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleManufacturerNameInstall extends Controller {

    private $error = [];
    private $module = 'manufacturer_name';

    /**
     * ControllerModuleManufacturerNameInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleManufacturerNameInstall::validate()
     * 
     * @return
     */
