<?php
/**
 * ControllerModuleProductOverviewUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductOverviewUninstall extends Controller {
	private $error = [];
    private $module = 'product_overview';
	
	/**
	 * ControllerModuleProductOverviewUninstall::index()
	 * 
	 * @return
	 */
