...
/**
 * ControllerModuleProductOverviewInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductOverviewInstall extends Controller {

    private $error = [];
    private $module = 'product_overview';

    /**
     * ControllerModuleProductOverviewInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductOverviewInstall::validate()
     * 
     * @return
     */
