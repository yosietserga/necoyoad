...
/**
 * ControllerModuleRegisterFormPlugin
 * 
 * @package   
 * @author NecoTienda
 ...
 * @access public
 */
class ControllerModuleRegisterFormPlugin extends Controller {

    private $error = [];
    private $module = 'register_form';

    /**
     * ControllerModuleRegisterFormPlugin::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleRegisterFormPlugin::validate()
     * 
     * @return
     */
