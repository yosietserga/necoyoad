...
/**
 * ControllerModuleRegisterFormInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleRegisterFormInstall extends Controller {

    private $error = [];
    private $module = 'register_form';

    /**
     * ControllerModuleRegisterFormInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleRegisterFormInstall::validate()
     * 
     * @return
     */
