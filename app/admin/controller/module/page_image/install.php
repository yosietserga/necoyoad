...
/**
 * ControllerModulePageImageInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePageImageInstall extends Controller {

    private $error = [];
    private $module = 'page_image';

    /**
     * ControllerModulePageImageInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePageImageInstall::validate()
     * 
     * @return
     */
