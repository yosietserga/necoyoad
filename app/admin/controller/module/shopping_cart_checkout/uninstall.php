<?php
/**
 * ControllerModuleShoppingCartCheckoutUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleShoppingCartCheckoutUninstall extends Controller {
	private $error = [];
    private $module = 'shopping_cart_checkout';
	
	/**
	 * ControllerModuleShoppingCartCheckoutUninstall::index()
	 * 
	 * @return
	 */
