...
/**
 * ControllerModuleShoppingCartCheckoutInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleShoppingCartCheckoutInstall extends Controller {

    private $error = [];
    private $module = 'shopping_cart_checkout';

    /**
     * ControllerModuleShoppingCartCheckoutInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleShoppingCartCheckoutInstall::validate()
     * 
     * @return
     */
