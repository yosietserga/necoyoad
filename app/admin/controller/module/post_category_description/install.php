...
/**
 * ControllerModulePostCategoryDescriptionInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryDescriptionInstall extends Controller {

    private $error = [];
    private $module = 'post_category_description';

    /**
     * ControllerModulePostCategoryDescriptionInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostCategoryDescriptionInstall::validate()
     * 
     * @return
     */
