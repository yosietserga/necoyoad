<?php
/**
 * ControllerModulePostCategoryDescriptionUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryDescriptionUninstall extends Controller {
	private $error = [];
    private $module = 'post_category_description';
	
	/**
	 * ControllerModulePostCategoryDescriptionUninstall::index()
	 * 
	 * @return
	 */
