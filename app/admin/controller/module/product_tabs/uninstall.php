...
/**
 * ControllerModuleProductTabsUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductTabsUninstall extends Controller {

    private $error = [];
    private $module = 'product_tabs';

    /**
     * ControllerModuleProductTabsUninstall::index()
     * 
     * @return
     */
