...
/**
 * ControllerModuleFacebookCommentsInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleFacebookCommentsInstall extends Controller {

    private $error = [];
    private $module = 'facebook_comments';

    /**
     * ControllerModuleFacebookCommentsInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleFacebookCommentsInstall::validate()
     * 
     * @return
     */
