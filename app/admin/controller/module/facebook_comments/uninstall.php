<?php
/**
 * ControllerModuleFacebookCommentsUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleFacebookCommentsUninstall extends Controller {
	private $error = [];
    private $module = 'facebook_comments';
	
	/**
	 * ControllerModuleFacebookCommentsUninstall::index()
	 * 
	 * @return
	 */
