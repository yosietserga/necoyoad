...
/**
 * ControllerModuleProductOrderFormInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductOrderFormInstall extends Controller {

    private $error = [];
    private $module = 'product_order_form';

    /**
     * ControllerModuleProductOrderFormInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductOrderFormInstall::validate()
     * 
     * @return
     */
