...
/**
 * ControllerModuleProductOrderFormPlugin
 * 
 * @package   
 * @author NecoTienda
 ...
 * @access public
 */
class ControllerModuleProductOrderFormPlugin extends Controller {

    private $error = [];
    private $module = 'product_order_form';

    /**
     * ControllerModuleProductOrderFormPlugin::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductOrderFormPlugin::validate()
     * 
     * @return
     */
