<?php
/**
 * ControllerModuleProductOrderFormUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductOrderFormUninstall extends Controller {
	private $error = [];
    private $module = 'product_order_form';
	
	/**
	 * ControllerModuleProductOrderFormUninstall::index()
	 * 
	 * @return
	 */
