...
/**
 * ControllerModuleProductTitleInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductTitleInstall extends Controller {

    private $error = [];
    private $module = 'product_title';

    /**
     * ControllerModuleProductTitleInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductTitleInstall::validate()
     * 
     * @return
     */
