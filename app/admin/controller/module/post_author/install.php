...
/**
 * ControllerModulePostAuthorInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostAuthorInstall extends Controller {

    private $error = [];
    private $module = 'post_author';

    /**
     * ControllerModulePostAuthorInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostAuthorInstall::validate()
     * 
     * @return
     */
