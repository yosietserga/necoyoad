<?php
/**
 * ControllerModuleShoppingCartBoxUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleShoppingCartBoxUninstall extends Controller {
	private $error = [];
    private $module = 'shopping_cart_box';
	
	/**
	 * ControllerModuleShoppingCartBoxUninstall::index()
	 * 
	 * @return
	 */
