...
/**
 * ControllerModuleShoppingCartBoxInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleShoppingCartBoxInstall extends Controller {

    private $error = [];
    private $module = 'shopping_cart_box';

    /**
     * ControllerModuleShoppingCartBoxInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleShoppingCartBoxInstall::validate()
     * 
     * @return
     */
