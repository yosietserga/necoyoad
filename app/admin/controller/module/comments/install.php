...
/**
 * ControllerModuleCommentsInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCommentsInstall extends Controller {

    private $error = [];
    private $module = 'comments';

    /**
     * ControllerModuleCommentsInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleCommentsInstall::validate()
     * 
     * @return
     */
