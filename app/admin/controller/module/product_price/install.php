...
/**
 * ControllerModuleProductPriceInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductPriceInstall extends Controller {

    private $error = [];
    private $module = 'product_price';

    /**
     * ControllerModuleProductPriceInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductPriceInstall::validate()
     * 
     * @return
     */
