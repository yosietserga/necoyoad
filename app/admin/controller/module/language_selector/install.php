...
/**
 * ControllerModuleLanguageSelectorInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleLanguageSelectorInstall extends Controller {

    private $error = [];
    private $module = 'language_selector';

    /**
     * ControllerModuleLanguageSelectorInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleLanguageSelectorInstall::validate()
     * 
     * @return
     */
