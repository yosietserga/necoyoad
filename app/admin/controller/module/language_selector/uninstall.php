<?php
/**
 * ControllerModuleLanguageSelectorUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleLanguageSelectorUninstall extends Controller {
	private $error = [];
    private $module = 'language_selector';
	
	/**
	 * ControllerModuleLanguageSelectorUninstall::index()
	 * 
	 * @return
	 */
