...
/**
 * ControllerModuleProductDescriptionInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductDescriptionInstall extends Controller {

    private $error = [];
    private $module = 'product_description';

    /**
     * ControllerModuleProductDescriptionInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleProductDescriptionInstall::validate()
     * 
     * @return
     */
