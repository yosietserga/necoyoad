<?php
/**
 * ControllerModuleProductDescriptionUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductDescriptionUninstall extends Controller {
	private $error = [];
    private $module = 'product_description';
	
	/**
	 * ControllerModuleProductDescriptionUninstall::index()
	 * 
	 * @return
	 */
