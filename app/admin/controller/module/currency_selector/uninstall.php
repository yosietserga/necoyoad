<?php
/**
 * ControllerModuleCurrencySelectorUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCurrencySelectorUninstall extends Controller {
	private $error = [];
    private $module = 'currency_selector';
	
	/**
	 * ControllerModuleCurrencySelectorUninstall::index()
	 * 
	 * @return
	 */
