...
/**
 * ControllerModuleCurrencySelectorInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleCurrencySelectorInstall extends Controller {

    private $error = [];
    private $module = 'currency_selector';

    /**
     * ControllerModuleCurrencySelectorInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleCurrencySelectorInstall::validate()
     * 
     * @return
     */
