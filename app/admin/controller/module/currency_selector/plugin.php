...
/**
 * ControllerModuleCurrencySelectorPlugin
 * 
 * @package   
 * @author NecoTienda
 ...
 * @access public
 */
class ControllerModuleCurrencySelectorPlugin extends Controller {

    private $error = [];
    private $module = 'currency_selector';

    /**
     * ControllerModuleCurrencySelectorPlugin::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleCurrencySelectorPlugin::validate()
     * 
     * @return
     */
