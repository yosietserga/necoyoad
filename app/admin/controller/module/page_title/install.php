...
/**
 * ControllerModulePageTitleInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePageTitleInstall extends Controller {

    private $error = [];
    private $module = 'page_title';

    /**
     * ControllerModulePageTitleInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePageTitleInstall::validate()
     * 
     * @return
     */
