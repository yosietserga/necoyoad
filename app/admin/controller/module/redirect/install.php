...
/**
 * ControllerModuleRedirectInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleRedirectInstall extends Controller {

    private $error = [];
    private $module = 'redirect';

    /**
     * ControllerModuleRedirectInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleRedirectInstall::validate()
     * 
     * @return
     */
