...
/**
 * ControllerModuleRedirectPlugin
 * 
 * @package   
 * @author NecoTienda
 ...
 * @access public
 */
class ControllerModuleRedirectPlugin extends Controller {

    private $error = [];
    private $module = 'redirect';

    /**
     * ControllerModuleRedirectPlugin::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleRedirectPlugin::validate()
     * 
     * @return
     */
