...
/**
 * ControllerModuleLoginFormInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleLoginFormInstall extends Controller {

    private $error = [];
    private $module = 'login_form';

    /**
     * ControllerModuleLoginFormInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleLoginFormInstall::validate()
     * 
     * @return
     */
