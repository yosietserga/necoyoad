...
/**
 * ControllerModulePostDescriptionInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostDescriptionInstall extends Controller {

    private $error = [];
    private $module = 'post_description';

    /**
     * ControllerModulePostDescriptionInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostDescriptionInstall::validate()
     * 
     * @return
     */
