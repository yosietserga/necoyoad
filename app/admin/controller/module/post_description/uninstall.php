<?php
/**
 * ControllerModulePostDescriptionUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostDescriptionUninstall extends Controller {
	private $error = [];
    private $module = 'post_description';
	
	/**
	 * ControllerModulePostDescriptionUninstall::index()
	 * 
	 * @return
	 */
