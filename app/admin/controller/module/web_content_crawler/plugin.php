...
/**
 * ControllerModuleWebContentCrawlerPlugin
 * 
 * @package   
 * @author NecoTienda
 ...
 * @access public
 */
class ControllerModuleWebContentCrawlerPlugin extends Controller {

    private $error = [];
    private $module = 'web_content_crawler';

    /**
     * ControllerModuleWebContentCrawlerPlugin::index()
     * 
     * @return
     */
    public function index() {
        ...
        if (isset($this->request->post['iframe_url'])) {
            $this->data['iframe_url'] = $this->request->post['iframe_url'];
        } else {
            $this->data['iframe_url'] = $this->config->get('iframe_url');
        }
    ...
    /**
     * ControllerModuleWebContentCrawlerPlugin::validate()
     * 
     * @return
     */
