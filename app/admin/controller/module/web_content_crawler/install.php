...
/**
 * ControllerModuleWebContentCrawlerInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleWebContentCrawlerInstall extends Controller {

    private $error = [];
    private $module = 'web_content_crawler';

    /**
     * ControllerModuleWebContentCrawlerInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleWebContentCrawlerInstall::validate()
     * 
     * @return
     */
