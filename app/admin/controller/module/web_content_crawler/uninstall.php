<?php
/**
 * ControllerModuleWebContentCrawlerUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleWebContentCrawlerUninstall extends Controller {
	private $error = [];
    private $module = 'web_content_crawler';
	
	/**
	 * ControllerModuleWebContentCrawlerUninstall::index()
	 * 
	 * @return
	 */
