...
/**
 * ControllerModulePostOverviewInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostOverviewInstall extends Controller {

    private $error = [];
    private $module = 'post_overview';

    /**
     * ControllerModulePostOverviewInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostOverviewInstall::validate()
     * 
     * @return
     */
