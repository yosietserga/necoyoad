...
/**
 * ControllerModuleProductFilterAttributesInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductFilterAttributesInstall extends Controller {

    private $error = [];
    private $module = 'product_filter_attributes';

    /**
     * ControllerModuleProductFilterAttributesInstall::index()
     *
     * @return
     */
