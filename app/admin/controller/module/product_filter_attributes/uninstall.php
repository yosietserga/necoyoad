<?php
/**
 * ControllerModuleProductFilterAttributesUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductFilterAttributesUninstall extends Controller {
	private $error = [];
    private $module = 'product_filter_attributes';
	
	/**
	 * ControllerModuleProductFilterAttributesUninstall::index()
	 * 
	 * @return
	 */
