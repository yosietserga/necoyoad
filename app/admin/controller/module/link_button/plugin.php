...
/**
 * ControllerModuleLinkButtonPlugin
 * 
 * @package   
 * @author NecoTienda
 ...
 * @access public
 */
class ControllerModuleLinkButtonPlugin extends Controller {

    private $error = [];
    private $module = 'link_button';

    /**
     * ControllerModuleLinkButtonPlugin::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleLinkButtonPlugin::validate()
     * 
     * @return
     */
