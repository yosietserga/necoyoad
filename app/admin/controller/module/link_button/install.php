...
/**
 * ControllerModuleLinkButtonInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleLinkButtonInstall extends Controller {

    private $error = [];
    private $module = 'link_button';

    /**
     * ControllerModuleLinkButtonInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleLinkButtonInstall::validate()
     * 
     * @return
     */
