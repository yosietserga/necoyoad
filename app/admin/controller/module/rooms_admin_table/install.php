...
/**
 * ControllerModuleRoomsAdminTableInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleRoomsAdminTableInstall extends Controller {

    private $error = [];
    private $module = 'rooms_admin_table';

    /**
     * ControllerModuleRoomsAdminTableInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleRoomsAdminTableInstall::validate()
     * 
     * @return
     */
