...
/**
 * ControllerModuleRoomsAdminTablePlugin
 * 
 * @package   
 * @author NecoTienda
 ...
 * @access public
 */
class ControllerModuleRoomsAdminTablePlugin extends Controller {

    private $error = [];
    private $module = 'rooms_admin_table';

    /**
     * ControllerModuleRoomsAdminTablePlugin::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleRoomsAdminTablePlugin::validate()
     * 
     * @return
     */
