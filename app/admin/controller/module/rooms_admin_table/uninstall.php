<?php
/**
 * ControllerModuleRoomsAdminTableUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleRoomsAdminTableUninstall extends Controller {
	private $error = [];
    private $module = 'rooms_admin_table';
	
	/**
	 * ControllerModuleRoomsAdminTableUninstall::index()
	 * 
	 * @return
	 */
