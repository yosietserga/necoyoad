<?php
/**
 * ControllerModuleProductModelUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleProductModelUninstall extends Controller {
	private $error = [];
    private $module = 'product_model';
	
	/**
	 * ControllerModuleProductModelUninstall::index()
	 * 
	 * @return
	 */
