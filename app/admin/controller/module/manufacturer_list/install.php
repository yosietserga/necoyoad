...
/**
 * ControllerModuleManufacturerListInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleManufacturerListInstall extends Controller {

    private $error = [];
    private $module = 'manufacturer_list';

    /**
     * ControllerModuleManufacturerListInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleManufacturerListInstall::validate()
     * 
     * @return
     */
