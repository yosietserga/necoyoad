<?php
/**
 * ControllerModuleManufacturerListUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleManufacturerListUninstall extends Controller {
	private $error = [];
    private $module = 'manufacturer_list';
	
	/**
	 * ControllerModuleManufacturerListUninstall::index()
	 * 
	 * @return
	 */
