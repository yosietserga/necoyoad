 ...
 * @see Controller
 */
class ControllerModuleImageInstall extends Controller {

    private $error = [];
    private $module = 'image';

    /**
     * ControllerModuleImageInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModuleImageInstall::validate()
     * 
     * @return
     */
