<?php
/**
 * ControllerModulePostCategoryImageUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryImageUninstall extends Controller {
	private $error = [];
    private $module = 'post_category_image';
	
	/**
	 * ControllerModulePostCategoryImageUninstall::index()
	 * 
	 * @return
	 */
