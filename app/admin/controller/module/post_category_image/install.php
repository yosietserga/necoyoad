...
/**
 * ControllerModulePostCategoryImageInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostCategoryImageInstall extends Controller {

    private $error = [];
    private $module = 'post_category_image';

    /**
     * ControllerModulePostCategoryImageInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostCategoryImageInstall::validate()
     * 
     * @return
     */
