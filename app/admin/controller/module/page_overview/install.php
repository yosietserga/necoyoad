...
/**
 * ControllerModulePageOverviewInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePageOverviewInstall extends Controller {

    private $error = [];
    private $module = 'page_overview';

    /**
     * ControllerModulePageOverviewInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePageOverviewInstall::validate()
     * 
     * @return
     */
