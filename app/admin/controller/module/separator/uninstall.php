<?php
/**
 * ControllerModuleSeparatorUninstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModuleSeparatorUninstall extends Controller {
	private $error = [];
    private $module = 'separator';
	
	/**
	 * ControllerModuleSeparatorUninstall::index()
	 * 
	 * @return
	 */
