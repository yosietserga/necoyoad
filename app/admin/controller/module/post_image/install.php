...
/**
 * ControllerModulePostImageInstall
 * 
 * @package NecoTienda
 * @author Yosiet Serga
 ...
 * @see Controller
 */
class ControllerModulePostImageInstall extends Controller {

    private $error = [];
    private $module = 'post_image';

    /**
     * ControllerModulePostImageInstall::index()
     * 
     * @return
     */
    ...
    /**
     * ControllerModulePostImageInstall::validate()
     * 
     * @return
     */
