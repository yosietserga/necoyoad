...
return [
    // Default connection name (Laravel reads config('database.default'))
    'default' => env('DB_CONNECTION', 'mysql'),

    // Connection definitions (Laravel reads config('database.connections.{name}'))
    'connections' => [
        'mysql' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'necoyoad_next'),
