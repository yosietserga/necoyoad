 ...
 */
(function($) {
    $.fn.ntContentCarousel = function(method) {
        var defaults = {
            baseUrl:    '',
            url:        '',
            type:       'get',
            dataType:   'json',
            classname:  'neco-content-carousel',
            image:      {
                classname: 'neco-content-carousel-image',
                height: 100,
                width: 100
            },
            next:       {
                classname:'neco-content-carousel-next'
            },
            prev:       {
                classname:'neco-content-carousel-prev'
            },
            pager:      {
                classname:'neco-content-carousel-pager'
            },
            loading:    {
                title:'Cargando...',
                image:'../loader.gif',
                classname:'neco-content-carousel-loading'
            },
            error:      {
                classname:'neco-content-carousel-error',
            ...
            _success: function(json) {
                ...
                if (json.error==1) {
                    ...
                    $.each(json.results, function(i,item) {
                        ...
                        data.output+="<li id='neco-content-carousel-item-" + data.count + i + "'>";
                        data.output+="<article>";
                        data.output+="<div>";
                        ...
                        if (item.description) {
                            data.output+="<p>" + item.description + "</p>";
                        }
        ...
        if (methods[method]) {
            ...
            $.error( 'Method "' +  method + '" does not exist in ntContentCarousel plugin!');
        }
    }
})(jQuery);
