...
All bug reports and problem issues require a jsFiddle. You can create one at [jsfiddle.net](https://jsfiddle.net).
...
If you would like to request or propose a feature, please do so in the the Slick subreddit - [reddit.com/r/slickcarousel](https://www.reddit.com/r/slickcarousel/). 
