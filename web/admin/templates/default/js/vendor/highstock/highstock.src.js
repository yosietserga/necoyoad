...
dateFormat = function (format, timestamp, capitalize) {
	...
	var date = new Date(timestamp),
		...
		// See https://jsfiddle.net/highcharts/7PB5N/ // docs
		replacements = extend({
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		canvasToolsURL: 'https://code.highcharts.com/stock/1.3.0/modules/canvas-tools.js',
		VMLRadialGradientURL: 'https://code.highcharts.com/stock/1.3.0/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
			...
			each(axes, function (axis) {
				...
				if (axis.isDirtyExtremes) { // #821
					...
					afterRedraw.push(function () { // prevent a recursive call to chart.redraw() (#1119)
                        $(chart.container).on('mouseup',function(){
                            fireEvent(axis, 'afterSetExtremes', axis.getExtremes()); // #747, #751
                            fireEvent(axis, 'afterSetExtremes', destroyEvents());});
	...
	seriesProto.init = function () {
		...
		if (xAxis && xAxis.options.ordinal && !xAxis.hasOrdinalExtension) {
			...
			xAxis.postProcessTickInterval = function (tickInterval) {
				// TODO: https://jsfiddle.net/highcharts/FQm4E/1/
