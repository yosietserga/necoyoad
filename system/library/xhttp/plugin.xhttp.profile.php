...
# Arvin Castro
# January 31, 2011
# https://codecri.me/sources/includes/class-xhttp-php/plugin-xhttp-profile-php/
...
class xhttp_profile {
	...
	public function getRequestData($profile) {
		return (isset(self::$datastore[$profile]['requestData'])) ? self::$datastore[$profile]['requestData']: [];
	}
